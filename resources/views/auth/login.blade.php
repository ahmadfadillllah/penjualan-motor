                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <form class="auth-login-form mt-2" action="index.html" method="POST">
                                    {{ csrf_field() }}
                                    <div class="mb-1">
                                        <label for="login-email" class="form-label">NIP</label>
                                        <input type="text" class="form-control" id="login-email" name="nip" placeholder="john@example.com" aria-describedby="login-email" tabindex="1" autofocus />
                                    </div>

                                    <div class="mb-1">
                                        <div class="d-flex justify-content-between">
                                            <label class="form-label" for="login-password" name="password">Password</label>
