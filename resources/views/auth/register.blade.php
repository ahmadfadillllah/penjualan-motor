                            ...
                            <div class="card-body">
                                ...
                                <form class="auth-register-form mt-2" action="index.html" method="POST">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" class="form-control" id="register-username" name="name" placeholder="johndoe" aria-describedby="register-username" tabindex="1" autofocus required/>
                                    </div>
                                    <div class="mb-1">
                                        <label for="register-email" class="form-label">Email</label>
                                        <input type="email" class="form-control" id="register-email" name="email" placeholder="john@example.com" aria-describedby="register-email" tabindex="2" required/>
                                    </div>
                                    <div class="mb-1">
                                        <label for="register-email" class="form-label">NIP</label>
                                        <input type="text" class="form-control" id="register-email" name="nip" placeholder="7371xxxxx" aria-describedby="register-email" tabindex="2" required/>
                                    </div>
